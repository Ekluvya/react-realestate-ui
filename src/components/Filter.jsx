    ...
    <div className="flex flex-col gap-[10px]">
      ...
      <div className="flex justify-between gap-[20px]">
        <div className="flex flex-col gap-[2px]">
          ...
          <select
            className="p-[10px] w-[100px] border-spanish-gray border border-solid rounded-sm text-sm"
            name="type"
            id="type"
          >
        ...
        <button className="bg-mustard w-[100px] p-[10px] flex justify-center items-center border-none cursor-pointer">
